...
const criarItemDeAtividade = (atividade) => {
  ...
  let input = `
   <input 
   onchenge="concluirAtividade(event)"
  ...
  <div class="card-bg">
   ${input}
    ...
    <div>
     ...
     <svg 
       class="active" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
     ...
     <svg 
       class="inactive" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
